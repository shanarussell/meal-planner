...
const style = {
  ...
  mainButtons: `w-full bg-[#5D9C59] text-white active:bg-pink-600 font-bold uppercase text-lg px-6 py-3 rounded-lg shadow hover:shadow-lg outline-none focus:outline-none m-2 ease-linear transition-all duration-150`,
};
